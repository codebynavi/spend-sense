...
function exportWord() {
    ...
    const html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><style>
              ...
              <h1>💰 Paisa Finder — Personal Budget Report</h1>
              ...
              <strong>Disclaimer:</strong> This report is generated by the Paisa Finder Personal Budget Calculator for illustration and personal planning purposes only. All figures are based on self-reported data. This does not constitute financial, tax, or investment advice. Please consult a qualified financial advisor for personalised guidance.
              </div>
              </body></html>`;
    ...
    a.download = 'Paisa_Finder_Budget_Report.doc';
    a.click();
}
...
function exportExcel() {
    ...
    // Overview sheet
    const overviewData = [
        ['PAISA FINDER — PERSONAL BUDGET REPORT'],
    ...
    XLSX.writeFile(wb, 'Paisa_Finder_Budget.xlsx');
}
